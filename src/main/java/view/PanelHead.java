...
public class PanelHead extends JPanel {
    ...
    private void init() {
        ...
        JButton btnBack = new JButton(ICON_BACK);
        JButton btnNext = new JButton(ICON_NEXT);
        JButton btnReload = new JButton(ICON_RELOAD);
        ...
        JPanel panelSearch = new JPanel(new FlowLayout(FlowLayout.LEADING, 0, 0));
        JTextField fieldSearch = new JTextField(20);
        JButton btnSearch = new JButton(ICON_SEARCH);
